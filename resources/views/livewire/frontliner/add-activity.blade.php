        ...
        <p>Add Activity</p>
          <div class="form-row">
            ...
            <div class="col-2">
              ...
              @else
                <button type="button" class="form-control form-control-sm bg-secondary text-white" data-toggle="modal" data-target="#add" disabled>Add Task</button>
              @endif
            </div>
          </div>
      </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="form-control form-control-sm bg-primary text-white" name="save" wire:click="save">Save changes</button>
        </div>
      </div>
    </div>
  </div>
